...
import re
from . import config
EXPORT_DIR = config.cfg.EXPORT_DIR
OLD_BASE = config.cfg.OLD_BASE
old_session = config.cfg.old_session
MAX_RETRIES = config.cfg.MAX_RETRIES
RETRY_DELAY = config.cfg.RETRY_DELAY
